                                ...
                                <c:choose>
                                    ...
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active">Accessories</li>
                                            ...
                                            <div class="product_name">${model.brand} ${model.model}</div>
                                            ...
                                            <div>
                                                <table class="col-md-12">
                                                    <tbody>
                                                        <tr class="row mt-10">
                                                            <td class="col-md-4"><span class="p_specification">Colour:</span> </td>
                                                            <td class="col-md-8">
                                                               ${model.colour}
                                                            </td>
                                                        </tr>
                                                        <tr class="row mt-10">
                                                            <td class="col-md-4"><span class="p_specification">Seating Capacity:</span> </td>
                                                            <td class="col-md-8">
                                                               ${model.capacity}
                                                            </td>
                                                        </tr>
                                                        <tr class="row mt-10">
                                                            <td class="col-md-4"><span class="p_specification">Transmissio:</span> </td>
                                                            <td class="col-md-8">
                                                               ${model.colour}
                                                            </td>
                                                        </tr>
                                                ...
                                                <!-- <span class="product_info">EMI starts at ₹ 2,000. No Cost EMI
                                                    Available<span><br> <span class="product_info">Warranty: 6 months
                                                            warranty<span><br> <span class="product_info">7 Days easy
                                                                    return policy<span><br> <span class="product_info">7
                                                                            Days easy return policy<span><br> <span
                                                                                    class="product_info">In Stock: 25
                                                                                    units sold this week<span>  -->
                                            ...
                                            <div class="row">
                                                <!-- <div class="col-xs-6" style="margin-left: 13px;">
                                                    <div class="product_quantity"> <span>QTY: </span> <input
                                                            id="quantity_input" type="text" pattern="[0-9]*" value="1">
                                                ...
                                                <div class="col-xs-6"> <button type="button"
                                                        class="btn btn-primary shop-button">Add to Cart</button> <button
                                                        type="button" class="btn btn-success shop-button">Buy
                                                        Now</button>
                                                    <div class="product_fav"><i class="bi-heart"></i></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
