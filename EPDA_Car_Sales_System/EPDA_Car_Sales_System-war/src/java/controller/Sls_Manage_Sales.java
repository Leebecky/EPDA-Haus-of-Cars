 ...
 * @author leebe
 */
@WebServlet(name = "Sls_Manage_Sales", urlPatterns = {"/Sls_Manage_Sales"})
public class Sls_Manage_Sales extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        RequestDispatcher rd = request.getRequestDispatcher("sls_manage_sales.jsp");
        try (PrintWriter out = response.getWriter()) {
            ...
            List<TxnSalesRecord> data = salesFacade.getSalesBySalesman(user.getUserId());
